    ...
    <>
      <nav className="bg-light border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 ">
          ...
          >
            <div className="flex flex-row flex-wrap -mx-36">
              <svg
                  id="logo-38"
                  width="78"
                  height="32"
          ...
          <div
              ...
              id="navbar-default"
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 
            mt-4 border border-gray-100 rounded-lg bg-gray-50 
          ...
          {/*the language flags*/}
          <ul className="">
            <li className="ml-3 space-x-2">
              <button
                  onClick={() => changeLanguage("en")}
                  className="cursor-pointer w-8 h-8 m-2 focus:scale-125"
              >
                <img src={iconUSA}></img>
              </button>
              <button
                  onClick={() => changeLanguage("ru")}
                  className="cursor-pointer w-8 h-8 focus:scale-125"
              >
                <img src={iconRUS}></img>
              </button>
            </li>
