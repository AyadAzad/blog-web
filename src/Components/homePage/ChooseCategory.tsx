...
const ChooseCategory = () => {
  const startupUrl = PostListData.find(
    (i) => i.path === "How-to-create-a-React-project"
  );
  const businessUrl = PostListData.find(
    (i) => i.path === "How-to-run-your-own-bussiness"
  );
